  ...
  return (
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f6fa' }}>
      <div style={{ background: 'white', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', width: '100%', maxWidth: '400px' }}>
        <h2 style={{ marginBottom: '8px', color: '#1a1a2e' }}>Create account</h2>
        <p style={{ color: '#888', marginBottom: '24px' }}>Join Events Platform today</p>

        {error && <div role="alert" style={{ background: '#fff0f0', color: '#e03131', padding: '10px', borderRadius: '6px', marginBottom: '16px' }}>{error}</div>}
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '16px' }}>
            <label htmlFor="register-name" style={{ display: 'block', marginBottom: '6px', fontWeight: '600', color: '#333' }}>Name</label>
            <input
              id="register-name"
              name="name"
              type="text"
          ...
          <div style={{ marginBottom: '16px' }}>
            <label htmlFor="register-email" style={{ display: 'block', marginBottom: '6px', fontWeight: '600', color: '#333' }}>Email</label>
            <input
              id="register-email"
              name="email"
              type="email"
          ...
          <div style={{ marginBottom: '24px' }}>
            <label htmlFor="register-password" style={{ display: 'block', marginBottom: '6px', fontWeight: '600', color: '#333' }}>Password <span style={{ color: '#999', fontWeight: '400', fontSize: '0.85rem' }}>(min 8 characters)</span></label>
            <input
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', color: '#666' }}>
          Already have an account? <Link to="/login" style={{ color: '#a970ff', fontWeight: '600' }}>Login</Link>
        </p>
      </div>
    </div>
  );
